...
typedef NS_ENUM(UInt8, PTTSCQRcodeEcclevel) {
    PTTSCQRcodeEcclevelL    = 'L',     ///< 7%
    PTTSCQRcodeEcclevelM    = 'M',     ///< 15%
    PTTSCQRcodeEcclevelQ    = 'Q',     ///< 25%
    PTTSCQRcodeEcclevelH    = 'H'      ///< 30%
};
...
typedef NS_ENUM(UInt8, PTTSCQRCodeMode) {
    PTTSCQRCodeModeAuto    = 'A',   ///< Auto
    PTTSCQRCodeModeManual  = 'M'    ///< Manual
};
...
typedef NS_ENUM(NSUInteger, PTTSCQRCodeModel) {
    PTTSCQRCodeModelM1    = 0,   ///< M1: (default), original version
    PTTSCQRCodeModelM2    = 1    ///< M2: enhanced version
};
...
typedef NS_ENUM(NSUInteger, PTTSCBitmapMode) {
    ...
    PTTSCBitmapModeCompress             = 3,  /*! *\~chinese 兼容旧的固件，新的固件已经废弃 *\~english Compatible with old models,New firmware has been deprecated */
...
typedef NS_ENUM(NSUInteger, PTTSCTextFontStyle) {
    PTTSCTextFontStyle0      = 0,   ///<  Monotye CG Triumvirate Bold Condensed, font width and height is stretchable
    PTTSCTextFontStyle1,            ///< 8x12
    PTTSCTextFontStyle2,            ///< 12x20
    PTTSCTextFontStyle3,            ///< 16x24
    PTTSCTextFontStyle4,            ///< 24x32
    PTTSCTextFontStyle5,            ///< 32x48
    PTTSCTextFontStyle6,            ///< 14x19
    PTTSCTextFontStyle7,            ///< 21x27
    PTTSCTextFontStyle8,            ///< 14x25
    PTTSCTextFontStyle9             ///< chinese,specify some printers
};
 ...
 *  \~chinese
 *
 *  @brief TSC-TSPL指令数据生成类
 *
 *  \~english
 *
 *  @brief TSC-TSPL Command Data Generate Class.
 *
 */
 ...
 *  \~english
 *
 *  This command defines the label width and length(mm).
 *
